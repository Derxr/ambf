...
for z in range(100):
	rr = random.randint
	rc = random.choice
	ugent = f"Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-A207F) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/{str(rr(0,73))}.0.{str(rr(1000,1900))}.{str(rr(40,150))} Mobile Safari/537.36"
	#ugent = f"Mozilla/5.0 (Linux; U; Android 11; th-th; CPH2121 Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,100))}.0.{str(rr(4200,4900))}.{str(rr(40,150))} Mobile Safari/537.36 HeyTapBrowser/45.8.3.1"
	#ugent2 = f"Mozilla/5.0 (Linux; Android {str(rr(2,12))}; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,100))}.0.{str(rr(4200,4900))}.{str(rr(40,150))} Mobile Safari/537.36 NokiaBrowser/1.0.1.54"
